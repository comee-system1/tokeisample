			...
			<div class="content">
				<div class="dashboard">
					...
					<div class="blank" v-if="!tiles.length">
						...
						<div>メニューバーの項目をクリックして、新しいタイルをダッシュボードに追加します。</div>
					</div>
				</div>
			</div>
		</div>
...
import Blank from '../parts/Blank.vue';
import BubbleChart from '../parts/BubbleChart.vue';
import BulletGraph from '../parts/BulletGraph.vue';
import ColumnChart from '../parts/ColumnChart.vue';
import Grid from '../parts/Grid.vue';
import LinearGauge from '../parts/LinearGauge.vue';
import LineChart from '../parts/LineChart.vue';
import RadialGauge from '../parts/RadialGauge.vue';
...
export default {
  ...
  data: function() {
    ...
    const widgets = [
			{ id: 'Grid', title: 'グリッド', icon: icons.grid },
			{ id: 'RadialGauge', title: '円形ゲージ', icon: icons.radialGauge },
			{ id: 'LinearGauge', title: '線形ゲージ', icon: icons.linearGauge },
			{ id: 'BarChart', title: '横棒グラフ', icon: icons.barChart },
			{ id: 'ColumnChart', title: '縦棒グラフ', icon: icons.columnChart },
			{ id: 'LineChart', title: '折れ線チャート', icon: icons.lineChart },
			{ id: 'BubbleChart', title: 'バブルチャート', icon: icons.bubbleChart },
			{ id: 'BulletGraph', title: 'ブレットグラフ', icon: icons.bulletGraph },
			{ id: 'Blank', title: '空白', icon: icons.blank },
		];
    const tiles = [
